...
import 'features/questions/presentation/screens/practice_session_create_screen.dart';
    ...
    return ScrollConfiguration(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/questions': (context) =>
              const QuestionBankScreen(), // Content management
          '/practice': (context) =>
              const PracticeSessionCreateScreen(), // Practice mode
        },
      ),
    );
  }
